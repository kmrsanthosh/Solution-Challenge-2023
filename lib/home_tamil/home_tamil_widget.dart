...
import 'home_tamil_model.dart';
export 'home_tamil_model.dart';

class HomeTamilWidget extends StatefulWidget {
  const HomeTamilWidget({Key? key}) : super(key: key);

  @override
  _HomeTamilWidgetState createState() => _HomeTamilWidgetState();
}

class _HomeTamilWidgetState extends State<HomeTamilWidget>
    with TickerProviderStateMixin {
  late HomeTamilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeTamilModel());
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'fycgs2ss' /* உங்கள் குழுவின் சுருக்கம் கீழே... */,
                                            ),
                                            textAlign: TextAlign.start,
                                                        ...
                                                        children: [
                                                          Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              '7hksvl2j' /* செயலில் உள்ள திட்டங்களின் எண்ண... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodySmall,
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        'eni68k8o' /* தற்போது 400 தொழிலாளர்கள் பணியி... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .titleSmall
                                          .override(
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              '42eo660q' /* Below is an a summary of activ... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodySmall,
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'yjbg616o' /* Below is an a summary of activ... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodySmall,
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        '963sfhav' /* திட்ட நிலையின் சுருக்கம் */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '7zq9y4hw' /* அனைத்து செயலில் உள்ள தொழிலாளர்... */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .titleMedium,
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'w1utyzqw' /* தற்போது செயல்படும் அனைத்து தொழ... */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
