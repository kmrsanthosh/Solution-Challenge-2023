...
class AppStateNotifier extends ChangeNotifier {
  GoogledcFirebaseUser? initialUser;
  GoogledcFirebaseUser? user;
  ...
  void update(GoogledcFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
          ...
          routes: [
            FFRoute(
              ...
              builder: (context, params) => LoginWidget(
                login: params.getParam('login', ParamType.int),
              ),
            ),
            FFRoute(
              name: 'forgotPassword',
            ...
            FFRoute(
              name: 'HomeConnect',
              path: 'homeConnect',
              builder: (context, params) => HomeConnectWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              ...
              path: 'homeTamil',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'HomeTamil')
                  : HomeTamilWidget(),
            ),
            FFRoute(
              name: 'HomeHindi',
              path: 'homeHindi',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'HomeHindi')
                  : HomeHindiWidget(),
            ),
            FFRoute(
              name: 'Splash',
            ...
            FFRoute(
              name: 'PincodeCopy',
              path: 'pincodeCopy',
              builder: (context, params) => PincodeCopyWidget(),
            ),
            FFRoute(
              name: 'LanguageSelectionCopy',
              path: 'languageSelectionCopy',
              builder: (context, params) => LanguageSelectionCopyWidget(),
            )
