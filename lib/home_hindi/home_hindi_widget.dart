...
import 'home_hindi_model.dart';
export 'home_hindi_model.dart';

class HomeHindiWidget extends StatefulWidget {
  const HomeHindiWidget({Key? key}) : super(key: key);

  @override
  _HomeHindiWidgetState createState() => _HomeHindiWidgetState();
}

class _HomeHindiWidgetState extends State<HomeHindiWidget>
    with TickerProviderStateMixin {
  late HomeHindiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeHindiModel());
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '6q9rv6l8' /* नीचे आपके समूह का सारांश है */,
                                            ),
                                            textAlign: TextAlign.start,
                                                        ...
                                                        children: [
                                                          Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'dxr7bsi7' /* सक्रिय परियोजनाओं की संख्या */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodySmall,
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        'eom2dwiv' /* वर्तमान में 400 कर्मचारी कार्य... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .titleSmall
                                          .override(
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'h72g2zhg' /* Below is an a summary of activ... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodySmall,
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'xbyfh1hm' /* Below is an a summary of activ... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodySmall,
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'rwqnupei' /* परियोजना की स्थिति का सारांश */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'k9gsc4ye' /* सभी सक्रिय कार्यकर्ता */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .titleMedium,
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'cyulabx1' /* सभी मौजूदा सक्रिय कर्मचारियों ... */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
